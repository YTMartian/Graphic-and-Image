...
+function ($) {
    ...
    var months = ['1月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],
        ...
        DCalendar = function (elem, options) {
            ...
            this.calendar.on('click', '#next', function () {
                ...
                var isPrev = $(this).hasClass('pMDate'),
                    ...
                    min = that.minDate === "今日" ? new Date(that.today.getFullYear(), that.today.getMonth(), that.today.getDate()) : new Date(that.minDate),
                    max = that.maxDate === "今日" ? new Date(that.today.getFullYear(), that.today.getMonth(), that.today.getDate()) : new Date(that.maxDate);
    ...
    DCalendar.prototype = {
        ...
        create: function (mode) {
            var that = this, cal = [],
                ...
                min = that.minDate === "今日" ? today : new Date(that.minDate),
                max = that.maxDate === "今日" ? today : new Date(that.maxDate);
            ...
            if (mode === "days") {
                ...
                tBody.append('<tr><td colspan="7" id="today"></td></tr>').appendTo(that.calendar);
            }
        }
    };
